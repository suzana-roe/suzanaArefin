...
L.easyButton(
  '<i class="fas fa-newspaper fa-1x" id="newsInfo" data-bs-toggle="modal" data-bs-target="#newsModal"></i>',
...
L.easyButton(
  '<i class="fas fa-virus fa-1x" id="coronaInfo" data-bs-toggle="modal" data-bs-target="#coronaModal"></i>',
...
L.easyButton(
  '<i class="fas fa-temperature-low fa-1x" id="weatherInfo" data-bs-toggle="modal" data-bs-target="#weatherModal"></i>',
...
//console.log("out");
L.easyButton(
  '<i class="fas fa-globe fa-1x" id="runBtn" data-bs-toggle="modal" data-bs-target="#exampleModal"></i>',
